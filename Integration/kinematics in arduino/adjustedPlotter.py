                ...
                if line.startswith("M:"):
                    ...
                    if plot_collecting:
                        ...
                        if 'dist_tool_dot' in data and 'pot_dist' in data and 'Desired_dist' in data:
                            ...
                            measurement_pot_dist.append(data['pot_dist']+20)
...
def plot_data():
    ...
    plt.figure()
    plt.plot(measurement_times, measurement_dist_tool_dot, label='Euclidian Distance Between Tool and Dot')
    plt.plot(measurement_times, measurement_pot_dist, label='Potentiometer Displacement')
